...
Write-Host "argocd app create app1-dev --repo https://github.com/rcorderoayigroup/team-a-MultiEnv.git --path team-a/app1/overlays/dev --dest-namespace team-a-dev --dest-server https://kubernetes.default.svc --project team-a-project"
